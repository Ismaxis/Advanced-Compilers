...
#task("1")[
  Примените алгоритм обхода в глубину с разворотом указателей [1, Algorithm 13.6]
  к состоянию памяти представленному на рис. 1 и ответьте на вопросы:
  1. Какие блоки памяти (достаточно указать адреса начала блоков) будут _помечены_ по итогу
  работы алгоритма?
...
#solution()[
  ...
  #align(center, sym.arrow.b + " нет полей указывающих на непомеченные блоки, выходим вверх по " + text[_стеку_])
